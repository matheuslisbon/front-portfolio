  ...
  return (
    <div className="w-full px-48 ">
      ...
      <div className="flex gap-10 mt-10">
        ...
        <Card className='w-2/6 shadow-lg dark:border-secondaryColor border-blue-500 hover:shadow-xl transition-shadow duration-300 backdrop-blur-sm' title="Frontend" color="blue">
          <CardHeader>
